...
fruits = {"apple":"red", "banana":"yellow","mango:":"green", "cherry":"red", "watermelon":"green"}
color_fruits = fruits.items()
for key, value in color_fruits: 
    print(f"{value} is the color of a {key}")
...
info_Karen = my_dict.items()
for key, value in info_Karen:
    print(f'{key}: {value}')
...
my_dict_2 = {"values_1":{"v1":3,"v2":6},"points":{"points1":9,"points2":[10,300,15]}}
print(my_dict_2["points"] ["points2"] [1])
...
my_dict3 = {"name":"Karen", "surname":"Jurgens", "age":35, "occupation":"Journalist"}

my_dict3.update({"country":"Colombia"})
my_dict3.update({"age": 36})
my_dict3.update({"occupation": "Editor"})
print(my_dict3)
